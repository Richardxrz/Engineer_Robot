...
typedef enum __DmMotorType{
    DM_M1_ID = 0x51,  // Master ID = Slave ID(0x01) + 0x50
    DM_M2_ID = 0x52,  // Master ID = Slave ID(0x02) + 0x50
    DM_M3_ID = 0x53,  // Master ID = Slave ID(0x03) + 0x50
    DM_M4_ID = 0x54,  // Master ID = Slave ID(0x04) + 0x50
    DM_M5_ID = 0x55,  // Master ID = Slave ID(0x05) + 0x50
    DM_M6_ID = 0x56,  // Master ID = Slave ID(0x06) + 0x50
} DmMotorType_e;
...
// CAN 总线状态监测
extern uint32_t can1_last_rx_time;
extern uint32_t can2_last_rx_time;
extern uint8_t can1_status;
extern uint8_t can2_status;
extern uint32_t can1_error_count;
extern uint32_t can2_error_count;
// clang-format on
