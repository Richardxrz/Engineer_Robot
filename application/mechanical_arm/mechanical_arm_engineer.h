...
typedef enum {
    ...
    MECHANICAL_ARM_INIT,
    MECHANICAL_ARM_HOLD,  // 保持位姿模式，允许底盘移动
} MechanicalArmMode_e;
...
extern MechanicalArmMode_e GetMechanicalArmMode(void);
extern float GetMechanicalArmJ0Angle(void);
